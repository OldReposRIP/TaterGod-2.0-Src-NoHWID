...
public class RotationUtil implements Util {
    ...
    public static boolean isInFov(BlockPos pos) {
        return pos != null && (RotationUtil.mc.player.getDistanceSq(pos) < 4.0D || isInFov(new Vec3d(pos), RotationUtil.mc.player.getPositionVector()));
    }

    public static boolean isInFov(Entity entity) {
        return entity != null && (RotationUtil.mc.player.getDistanceSq(entity) < 4.0D || isInFov(entity.getPositionVector(), RotationUtil.mc.player.getPositionVector()));
    }
